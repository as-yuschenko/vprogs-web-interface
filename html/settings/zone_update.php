<?php
	...
	try
	{
		$db->exec('UPDATE ppZone SET mainScreen = 0');
	}
	catch (Exception $e) 
	{
	...
	$stmt_mScr = $db->prepare('UPDATE ppZone SET mainScreen = 1 where id=:id');
	//prepare desc query
	$stmt_desc = $db->prepare('UPDATE ppZone SET desc=:desc where id=:id');
