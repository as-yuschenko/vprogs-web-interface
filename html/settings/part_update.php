<?php
	...
	try
	{
		$db->exec('UPDATE ppPart SET mainScreen = 0');
	}
	catch (Exception $e) 
	{
	...
	$stmt_mScr = $db->prepare('UPDATE ppPart SET mainScreen = 1 where id=:id');
	//prepare desc query
	$stmt_desc = $db->prepare('UPDATE ppPart SET desc=:desc where id=:id');
